...
The combined precipitation data for 2018 and 2019 has **`r nrow(precip_combined)`** rows and **`r ncol(precip_combined)`** columns(`r names(precip_combined)`). The total precipitation in 2018 is **`r sum(pull(precip_combined %>% filter(year == 2018) %>% select(total)))`** inches.
